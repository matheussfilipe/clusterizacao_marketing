...
if up_file is not None:
    ...
    st.write("""
                ...
                - **Grupo 1** está muito associado a esportes, especialmente futebol americano, basquete e atividades culturais como bandas e rock.
    ...
    st.write('Visualização dos resultados (10 primeiros regristros):')
    st.write(df.head(10))
    
    csv = df.to_csv(index = False)
    st.download_button('Baixar resultados completos', data = csv, file_name = 'Grupos_interesse.csv', mime = 'text/csv')
